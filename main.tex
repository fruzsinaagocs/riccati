...
Otherwise the timestep is rejected, and the algorithm
...
It switches adaptively between a new defect correction iteration on
the Riccati phase function (for oscillatory regions), and
a conventional solver (for smooth regions),
both of which are discretized to arbitrarily high order.
Its run time is independent of the maximum oscillation frequency.

*** NEED MORE EDIT: first decsribe method, how improves in acc
