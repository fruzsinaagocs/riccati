...
be referred to as \texttt{cascade}, named after the open-source software
implementing it\footnote{\texttt{cascade}: \textbf{c}ode for \textbf{a}daptive \textbf{s}pectral Ric\textbf{ca}ti \textbf{d}efect corr\textbf{e}ction.}.
...
\begin{itemize}
    \item{General
        \begin{itemize}
            ...
            \item{Our method has a name now! \texttt{cascade}:\texttt{cascade}: \textbf{c}ode for \textbf{a}daptive \textbf{s}pectral Ric\textbf{ca}ti \textbf{d}efect corr\textbf{e}ction. Used this in the legend in \cref{bremer237-timing}. }
        \end{itemize}
    }
    \item{Abstract
        \begin{itemize}
