...
run with the \texttt{OMP_NUM_THREADS=1} flag.
...
\item[Kummer's phase function method:]{ an arbitrarily high-order solver
        ...
        transitions to nonoscillatory behaviour. The user provides $\om$ as a callable.
...
% FA: I don't have dense output yet...
...
\begin{table*}
    \renewcommand{\arraystretch}{1.2}
    \resizebox{\textwidth}{!}{\input{tables/new/rdc/legendre-rdc.tex}}
...
(\cref{discr}), and its associated kink phenomenon visible in
the left panel of \cref{convergence-plot}.
