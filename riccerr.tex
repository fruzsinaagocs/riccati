...
\label{ricc}
\ee
\Fruzsi{For the sake of simplicity, let us set $\g(t)$ for the time being.}
...
the rate $r$ in \cref{R} deteriorates
...
By returning to \cref{R} and dropping the small second term
