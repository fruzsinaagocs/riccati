...
\begin{thm}\label{TR}
  ...
  \be
    r := \frac{1}{2\te_1 \rho} \left(1 + \frac{\te_2}{\te_1}\right) k + \frac{\Fruzsi{\te_3}}{4\te_1^2} \leq \frac{4}{5}
  \label{r}
  \ee
  where
  \Fruzsi{
  \begin{align}
      \te_1 &:= \eta_1 - \eta_4 - \frac{99\eta_3}{19\eta_1} - \frac{198\eta_2\eta_4}{99\eta_1},  \label{eta1} \\ 
      \te_2 &:= \eta_2 + \eta_4 + \frac{99\eta_3}{19\eta_1} + \frac{198\eta_2\eta_4}{99\eta_1},  \label{eta2} \\
...
\begin{rmk}
  ...
  then $r$ tends to $k/\om \rho$, where we can interpret $\om\rho$ as
    the number of oscillation periods across the ball radius \Fruzsi{times} $2\pi$.
    Then, for example, with a ball of radius \Fruzsi{5 periods}, $r$ satisfies \cref{r}
    for $k\le 25$.
\end{rmk}
...
%  and consider the iteration acting on the functions
    We take as the induction hypothesis that \Fruzsi{$x_\ell + \g$} (and thus $R_\ell$)
...
\left|\sum_{\ell=0}^{j} \frac{R_\ell}{2\left( x_\ell + \g \right)} \right|
\leq
\frac{5}{2}\frac{\eta_3 + 2\eta_2\eta_4}{\eta_1 - \eta_4 - \frac{99\eta_3}{19\eta_1} - \frac{198\eta_2\eta_4}{99\eta_1}},
$$
...
\left|\sum_{\ell=0}^{j} \frac{R_\ell}{2\left( x_\ell + \g \right)} \right| 
\leq
\frac{99\eta_3}{19\eta_1} + \frac{198\eta_2\eta_4}{198\eta_1},
$$
