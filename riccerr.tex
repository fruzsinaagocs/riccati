...
%only other arbitrarily high-order numerical solver for highly oscillatory
...
%\texttt{oscode} \cite{agocs2020efficient,agocs2020dense}, a low-order
%numerical solver for highly oscillatory ODEs. Importantly, \texttt{oscode} is 
